...
import { updateJobApplication } from "@/lib/actions/user/application-tracker"
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Type">
              <Select
                ...
                onValueChange={(v) =>
                  v != null && setEdit({ ...edit, employmentType: v })
                }
              >
            ...
            <Field label="Model">
              <Select
                ...
                onValueChange={(v) =>
                  v != null && setEdit({ ...edit, workModel: v })
                }
              >
                <SelectTrigger className="h-9 text-sm">
                  <SelectValue />
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-1 text-sm">
          {job.curriculumVitae && (
            <div>
              ...
              <span className="font-medium">{job.curriculumVitae.title}</span>
            </div>
          )}
          {job.coverLetter && (
            <div>
              <span className="text-muted-foreground">Cover letter </span>
              <span className="font-medium">{job.coverLetter.title}</span>
            </div>
          )}
        </div>
      )}
