...
export function ContentSkillsEditor({
  ...
  async function addSkillGroup() {
    const entry = newSkillGroup[sectionId] ?? {}
        ...
        update: [
          {
            ...
            data: {
              skillGroups: {
                create: [{ label: entry.label ?? "", skills, order: 0 }],
              },
            },
          },
        ],
  ...
  return (
    <div className="space-y-4">
      {(skillGroups ?? []).map((group: Record<string, unknown>) => (
        <div
          key={group.id}
      ...
      <div className="space-y-4 rounded-xl border-0 bg-zinc-50/50 p-5 shadow-sm dark:bg-zinc-800/30">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            value={newSkillGroup[sectionId]?.label ?? ""}
            onChange={(e) =>
              setNewSkillGroup({
                ...newSkillGroup,
                [sectionId]: {
                  ...newSkillGroup[sectionId],
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            value={newSkillGroup[sectionId]?.skills ?? ""}
            onChange={(e) =>
              setNewSkillGroup({
                ...newSkillGroup,
                [sectionId]: {
