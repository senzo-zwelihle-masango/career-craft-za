...
export function ContentRichTextEditor({
  ...
  function handleHeadingChange(val: string | null) {
  ...
  return (
    <div className="rounded-md border" style={{ minHeight }}>
      <div className="sticky top-0 z-10 flex flex-wrap items-center gap-0.5 border-b bg-white px-2 py-1.5 dark:bg-zinc-900">
        <Select value={getActiveHeading()} onValueChange={handleHeadingChange}>
          <SelectTrigger className="h-7 w-fit min-w-[100px] border-0 bg-transparent px-1 text-xs shadow-none focus:ring-0 [&_svg]:size-3.5">
            <SelectValue
              render={
                <span className="flex items-center gap-1.5">
                  {getActiveHeading() === "p" ? (
                    ...
                    <span className="text-[10px] font-bold">
                      {getActiveHeading().toUpperCase()}
                    </span>
                  )}
                  <span>
                    {
                      HEADING_OPTIONS.find(
                        (o) => o.value === getActiveHeading()
                      )?.label
                    }
                  </span>
                </span>
        ...
        <Toggle
          ...
          onPressedChange={handleOpenLink}
        >
        ...
        <div className="ml-auto flex items-center gap-0.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 rounded px-1.5 py-1 text-[10px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:opacity-50"
