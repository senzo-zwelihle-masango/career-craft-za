  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className="w-full justify-start text-left font-normal h-11 px-4 text-base"
        >
          <HugeiconsIcon icon={Calendar01Icon} className="shrink-0"/>
          {displayDate ? format(displayDate, "MM/yyyy") : <span className="text-muted-foreground">{placeholder}</span>}
        </Button>
      </PopoverTrigger>
