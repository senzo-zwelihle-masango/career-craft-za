...
import { ResponsiveThumbnail } from "@/components/curriculum-vitae/templates/_base/responsive-thumbnail"
...
export function CoverLetterThumbnail({
  ...
  return (
    <ResponsiveThumbnail className={className}>
      <div className="h-full bg-white text-black" style={{ fontFamily: font }}>
        {createElement(getCoverLetterTemplate(data.templateId), {
          data: templateData,
        })}
      </div>
    </ResponsiveThumbnail>
