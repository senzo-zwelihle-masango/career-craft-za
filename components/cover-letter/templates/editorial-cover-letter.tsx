...
export function EditorialCoverLetter({
  data,
}: {
  ...
  return (
    <div className="min-h-full bg-[#fffaf5] p-8 text-black md:p-10 lg:p-12">
      <div className="text-center">
        ...
        {data.professionalTitle && (
          <p className="mt-1 text-sm italic" style={{ color: `${accent}cc` }}>
            {data.professionalTitle}
          </p>
        )}
      ...
      <div
        className="my-6 text-center text-xs tracking-[0.5em]"
      ...
      {data.recipientName && (
        <p className="mt-4 text-center text-sm">Dear {data.recipientName},</p>
      )}

      {data.body ? (
        <div className="mt-4 text-center text-sm leading-relaxed whitespace-pre-line text-gray-800">
          {data.body}
        </div>
      ) : (
        <div
