...
export function CompactCoverLetter({
  ...
  return (
    <div className="min-h-full bg-white p-6 text-sm text-black md:p-8">
      <div className="mb-4 border-b-2 pb-4" style={{ borderColor: accent }}>
      ...
      {data.recipientName && (
        <p className="mt-3 text-sm">Dear {data.recipientName},</p>
      )}
      ...
      {data.body ? (
        ...
        <div
          className="mt-3 flex-1 text-sm italic"
