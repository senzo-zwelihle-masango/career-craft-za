...
export function PhotoPanel() {
  ...
  const photoObjectPosition =
    resume?.personalDetails?.photoObjectPosition || "50% 50%"
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col items-center gap-3">
        {photoUrl ? (
          <div className="relative">
            ...
            <button
              onClick={removePhoto}
              className="text-destructive-foreground absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-destructive text-[10px]"
            >
              ×
            </button>
          </div>
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <Switch
          ...
          onCheckedChange={(v) =>
            updateResumeState({ showPhoto: v } as Partial<CvWithRelations>)
          }
        />
      </div>
