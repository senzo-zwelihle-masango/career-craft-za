...
import { updateSectionVisibility, reorderSections } from "@/lib/actions/curriculum-vitae"
...
export function SectionsPanel() {
  ...
  async function handleDragEnd(event: DragEndEvent) {
    ...
    useEditorStore.getState().updateCv({ sections: updatedSections } as Partial<CvWithRelations>)
    await reorderSections(resume.id, reordered.map((s) => s.id))
  }
