...
export function EditorialRuleTemplate({ resume }: { resume: CvWithRelations }) {
...
export const templateMeta: TemplateMeta = {
  slug: "editorial-rule",
  name: "Editorial Rule",
  description: "Magazine editorial layout — decorative ruled headings, ornamental dividers, justified text",
  categories: ["simple"],
  columnLayout: "single",
  supportsPhoto: false,
  sidebarSectionTypes: [],
