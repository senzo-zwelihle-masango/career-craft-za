...
// Simple
import { CleanLineTemplate, templateMeta as cleanLineMeta } from "./simple/clean-line"
import { EditorialRuleTemplate, templateMeta as editorialRuleMeta } from "./simple/editorial-rule"
import { StructuredProTemplate, templateMeta as structuredProMeta } from "./simple/structured-pro"
import { CentredSerifTemplate, templateMeta as centredSerifMeta } from "./simple/centred-serif"

// Modern
import { SidebarSlateTemplate, templateMeta as sidebarSlateMeta } from "./modern/sidebar-slate"
import { AccentBandTemplate, templateMeta as accentBandMeta } from "./modern/accent-band"
import { SplitHeadTemplate, templateMeta as splitHeadMeta } from "./modern/split-head"
import { GradientCapTemplate, templateMeta as gradientCapMeta } from "./modern/gradient-cap"

// Creative
import { RuledEditorial as RuledEditorialTemplate, templateMeta as ruledEditorialMeta } from "./creative/ruled-editorial"
import { BoldStamp as BoldStampTemplate, templateMeta as boldStampMeta } from "./creative/bold-stamp"
import { SidebarInk as SidebarInkTemplate, templateMeta as sidebarInkMeta } from "./creative/sidebar-ink"

// Photo
import { PhotoHeaderFloatTemplate, templateMeta as photoHeaderFloatMeta } from "./photo/photo-header-float"
import { PhotoCentredTemplate, templateMeta as photoCentredMeta } from "./photo/photo-centred"

// Compact
import { ExecFormalTemplate, templateMeta as execFormalMeta } from "./compact/exec-formal"
import { DenseTwoColTemplate, templateMeta as denseTwoColMeta } from "./compact/dense-two-col"
import { CondensedRuleTemplate, templateMeta as condensedRuleMeta } from "./compact/condensed-rule"

// First Job
import { GraduateFirstTemplate, templateMeta as graduateFirstMeta } from "./first-job/graduate-first"
import { StudentSidebarTemplate, templateMeta as studentSidebarMeta } from "./first-job/student-sidebar"
...
function register(slug: string, component: TemplateComponent, meta: typeof cleanLineMeta) {
