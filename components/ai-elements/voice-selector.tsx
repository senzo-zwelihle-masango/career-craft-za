...
import { useControllableState } from "@/components/ai-elements/use-controllable-state"
...
export const VoiceSelectorGender = ({
  ...
  switch (value) {
    ...
    case "non-binary": {
      icon = <HugeiconsIcon icon={NeutralIcon} className="size-4" />
      break
    }
    case "intersex": {
      icon = <HugeiconsIcon icon={ManWomanIcon} className="size-4" />
      break
    }
    default: {
