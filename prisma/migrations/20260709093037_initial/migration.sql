...
-- CreateEnum
CREATE TYPE "FeedbackType" AS ENUM ('BUG_REPORT', 'FEATURE_REQUEST', 'GENERAL', 'REVIEW');
...
CREATE TABLE "personalDetails" (
    ...
    "location" TEXT,
    "photoUrl" TEXT,
    "photoObjectPosition" TEXT DEFAULT 'center',
    "photoCrop" JSONB,
    "nationality" TEXT,
...
CREATE TABLE "community_vote" (
    ...
    CONSTRAINT "community_vote_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "community_comment_parentId_idx" ON "community_comment"("parentId");

-- CreateIndex
CREATE INDEX "community_vote_postId_idx" ON "community_vote"("postId");

-- CreateIndex
CREATE INDEX "community_vote_commentId_idx" ON "community_vote"("commentId");

-- CreateIndex
CREATE INDEX "community_vote_userId_idx" ON "community_vote"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "community_vote_userId_postId_key" ON "community_vote"("userId", "postId");

-- CreateIndex
CREATE UNIQUE INDEX "community_vote_userId_commentId_key" ON "community_vote"("userId", "commentId");

-- CreateIndex
CREATE INDEX "community_report_postId_idx" ON "community_report"("postId");

-- CreateIndex
CREATE INDEX "community_report_commentId_idx" ON "community_report"("commentId");

-- CreateIndex
CREATE INDEX "community_report_userId_idx" ON "community_report"("userId");
...
-- AddForeignKey
ALTER TABLE "community_comment" ADD CONSTRAINT "community_comment_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "community_comment"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "community_vote" ADD CONSTRAINT "community_vote_postId_fkey" FOREIGN KEY ("postId") REFERENCES "community_post"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "community_vote" ADD CONSTRAINT "community_vote_commentId_fkey" FOREIGN KEY ("commentId") REFERENCES "community_comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "community_vote" ADD CONSTRAINT "community_vote_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "community_report" ADD CONSTRAINT "community_report_postId_fkey" FOREIGN KEY ("postId") REFERENCES "community_post"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "community_report" ADD CONSTRAINT "community_report_commentId_fkey" FOREIGN KEY ("commentId") REFERENCES "community_comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "community_report" ADD CONSTRAINT "community_report_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
