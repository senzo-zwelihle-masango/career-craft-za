...
export async function GET(
  ...
  const { FONT_FAMILY_MAP } = await import("@/components/templates/_base/font-map")
  ...
  const pageSize = cv.pageFormat === "LETTER" ? "letter" : "A4"
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { margin: 0; padding: 0; width: 210mm; overflow: hidden; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
